...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['urn', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      likeCount: formatNumber(safeGet(item, ['socialDetail.totalLikes', 'likeCount'], 0)),
      commentCount: formatNumber(safeGet(item, ['socialDetail.totalComments', 'commentCount'], 0)),
    },
 ...
 */
const formatLinkedin_Web = formatItem;
const formatLinkedin_App = formatItem;
const formatLinkedin_Search = formatItem;
