...
function formatItem(rawData) {
  ...
  return {
    ...
    stats: {
      playCount: formatNumber(safeGet(item, ['play_count', 'playCount'], 0)),
      likeCount: formatNumber(safeGet(item, ['digg_count', 'likeCount'], 0)),
 ...
 */
const formatTiktok_Web = formatItem;
const formatTiktok_App = formatItem;
const formatTiktok_Search = formatItem;
