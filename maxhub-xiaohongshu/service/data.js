...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['note_id', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      likeCount: formatNumber(safeGet(item, ['liked_count', 'likeCount'], 0)),
      collectCount: formatNumber(safeGet(item, ['collected_count', 'collectCount'], 0)),
      commentCount: formatNumber(safeGet(item, ['comment_count', 'commentCount'], 0)),
      shareCount: formatNumber(safeGet(item, ['share_count', 'shareCount'], 0)),
    },
 ...
 */
const formatXiaohongshu_Web = formatItem;
const formatXiaohongshu_App = formatItem;
const formatXiaohongshu_Search = formatItem;
...
module.exports = {
  ...
  formatItem,
  formatData,
  formatXiaohongshu_Web,
  formatXiaohongshu_App,
  formatXiaohongshu_Search,
};
