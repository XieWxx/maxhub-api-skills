...
const API_REGISTRY = {
  // app
  getArticleInfo: { path: '/app/get_article_info', params: ['group_id'], price: 0.01 },
  getVideoInfo: { path: '/app/get_video_info', params: ['group_id'], price: 0.01 },
  getUserInfo: { path: '/app/get_user_info', params: ['user_id'], price: 0.01 },
  getUserId: { path: '/app/get_user_id', params: ['user_profile_url'], price: 0.01 },
  getComments: { path: '/app/get_comments', params: ['group_id', 'offset'], price: 0.01 },
};
