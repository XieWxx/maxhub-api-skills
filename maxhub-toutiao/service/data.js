...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['item_id', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      readCount: formatNumber(safeGet(item, ['read_count', 'readCount'], 0)),
 ...
 */
const formatToutiao_Web = formatItem;
const formatToutiao_App = formatItem;
const formatToutiao_Search = formatItem;
