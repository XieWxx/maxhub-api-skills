...
`GET /api/v1/bilibili/.../fetch_bangumi_tab`
...
`GET /api/v1/bilibili/.../fetch_general_search`
...
`GET /api/v1/bilibili/.../fetch_search_all`
...
`GET /api/v1/bilibili/.../fetch_search_by_type`
