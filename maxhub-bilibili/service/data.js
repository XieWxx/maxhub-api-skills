...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['bvid', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      playCount: formatNumber(safeGet(item, ['stat.view', 'playCount'], 0)),
      likeCount: formatNumber(safeGet(item, ['stat.like', 'likeCount'], 0)),
      commentCount: formatNumber(safeGet(item, ['stat.reply', 'commentCount'], 0)),
      shareCount: formatNumber(safeGet(item, ['stat.share', 'shareCount'], 0)),
      collectCount: formatNumber(safeGet(item, ['stat.favorite', 'collectCount'], 0)),
    },
 ...
 */
const formatBilibili_Web = formatItem;
const formatBilibili_App = formatItem;
const formatBilibili_Search = formatItem;
