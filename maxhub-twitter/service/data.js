...
function formatItem(rawData) {
  ...
  return {
    ...
    stats: {
      likeCount: formatNumber(safeGet(item, ['favorite_count', 'likeCount'], 0)),
      retweetCount: formatNumber(safeGet(item, ['retweet_count', 'retweetCount'], 0)),
      replyCount: formatNumber(safeGet(item, ['reply_count', 'replyCount'], 0)),
    },
 ...
 */
const formatTwitter_Web = formatItem;
const formatTwitter_App = formatItem;
const formatTwitter_Search = formatItem;
