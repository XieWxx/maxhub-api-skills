...
function formatItem(rawData) {
  ...
  return {
    ...
    stats: {
      ...
      likeCount: formatNumber(safeGet(item, ['statistics.digg_count', 'likeCount'], 0)),
      commentCount: formatNumber(safeGet(item, ['statistics.comment_count', 'commentCount'], 0)),
      shareCount: formatNumber(safeGet(item, ['statistics.share_count', 'shareCount'], 0)),
      collectCount: formatNumber(safeGet(item, ['statistics.collect_count', 'collectCount'], 0)),
    },
 ...
 */
const formatDouyin_Web = formatItem;
const formatDouyin_App = formatItem;
const formatDouyin_Search = formatItem;
