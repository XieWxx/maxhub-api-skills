 ...
 */
function formatDouyin_Web(rawData) {
 ...
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_App_V3(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
 ...
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Search(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
...
/**
 * 格式化Douyin Billboard数据
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Billboard(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
 ...
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Creator(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
...
/**
 * 格式化Douyin Creator V2数据
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Creator_V2(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
 ...
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Index(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
 ...
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Xingtu(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
...
/**
 * 格式化Douyin Xingtu V2数据
 * 使用 safeGet 兼容不同API版本的返回字段差异
 */
function formatDouyin_Xingtu_V2(rawData) {
  if (!rawData) return null;
  const item = rawData.data || rawData.aweme_detail || rawData.item || rawData;
...
module.exports = {
  ...
  formatDouyin_App_V3,
  formatDouyin_Search,
  formatDouyin_Billboard,
  formatDouyin_Creator,
  formatDouyin_Creator_V2,
  formatDouyin_Index,
  formatDouyin_Xingtu,
  formatDouyin_Xingtu_V2,
};
