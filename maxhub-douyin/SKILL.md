...
**我返回：** 返回博主信息，包含粉丝数、获赞数、作品数、IP属地

### 获取视频详情

**你说：** `这个抖音视频的数据 https://v.douyin.com/xxx`

**我返回：** 返回视频详情，包含播放量、点赞、评论、分享、收藏数据

### 查看直播数据

**你说：** `这个抖音直播间有多少人在线`

**我返回：** 返回直播间信息，包含观看人数、点赞数、直播状态

### 获取视频评论

**你说：** `这个视频的评论数据`

**我返回：** 返回评论列表，包含评论内容、点赞数、IP属地
