...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['videoId', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      viewCount: formatNumber(safeGet(item, ['viewCount', 'viewCount'], 0)),
      likeCount: formatNumber(safeGet(item, ['likeCount', 'likeCount'], 0)),
      commentCount: formatNumber(safeGet(item, ['commentCount', 'commentCount'], 0)),
    },
 ...
 */
const formatYoutube_Web = formatItem;
const formatYoutube_App = formatItem;
const formatYoutube_Search = formatItem;
