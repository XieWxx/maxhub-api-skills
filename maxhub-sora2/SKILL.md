...
Sora2内容浏览——sora、sora2、ai视频等平台数据的智能采集与分析工具，支持视频搜索、用户分析、热门趋势追踪等能力，用自然语言即可获取数据。
...
直接输入：sora、sora2、ai视频、视频创作者、sora搜索

### 使用示例

1. 示例：Browse Sora2 AI video creations → 返回内容列表，包含标题、作者、点赞数
