...
function formatItem(rawData) {
  ...
  return {
    ...
    stats: {
      readCount: formatNumber(safeGet(item, ['read_num', 'readCount'], 0)),
      likeCount: formatNumber(safeGet(item, ['like_num', 'likeCount'], 0)),
    },
 ...
 */
const formatWechat_Web = formatItem;
const formatWechat_App = formatItem;
const formatWechat_Search = formatItem;
