...
const API_REGISTRY = {
  // api/v1/temp_mail/v1
  getTempEmailAddress: { path: '/api/v1/temp_mail/v1/get_temp_email_address', price: 0.01 },
  getEmailsInbox: { path: '/api/v1/temp_mail/v1/get_emails_inbox', params: ['token'], price: 0.01 },
  getEmailById: { path: '/api/v1/temp_mail/v1/get_email_by_id', params: ['token', 'message_id'], price: 0.01 },
};
