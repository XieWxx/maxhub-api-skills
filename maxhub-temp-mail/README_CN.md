...
2. 配置：`openclaw config set skills.entries.maxhub-temp-mail.apiKey "<你的-key>"` 或 `export MAXHUB_API_KEY="<你的-key>"`

## 使用示例

| 分类 | 示例指令 |
|------|----------|
| 邮箱操作 | 生成临时邮箱，get temp email，查收邮件，查看邮件内容 |
