...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['photo_id', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      playCount: formatNumber(safeGet(item, ['view_count', 'playCount'], 0)),
      likeCount: formatNumber(safeGet(item, ['like_count', 'likeCount'], 0)),
 ...
 */
const formatKuaishou_Web = formatItem;
const formatKuaishou_App = formatItem;
const formatKuaishou_Search = formatItem;
