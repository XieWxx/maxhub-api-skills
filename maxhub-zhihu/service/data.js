...
function formatItem(rawData) {
  ...
  return {
    ...
    stats: {
      voteupCount: formatNumber(safeGet(item, ['voteup_count', 'voteupCount'], 0)),
 ...
 */
const formatZhihu_Web = formatItem;
const formatZhihu_App = formatItem;
const formatZhihu_Search = formatItem;
