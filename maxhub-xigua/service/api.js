...
const API_REGISTRY = {
  // app/v2
  fetchOneVideo: { path: '/app/v2/fetch_one_video', params: ['item_id'], price: 0.01 },
  fetchOneVideoV2: { path: '/app/v2/fetch_one_video_v2', params: ['item_id'], price: 0.01 },
  fetchOneVideoPlayUrl: { path: '/app/v2/fetch_one_video_play_url', params: ['item_id'], price: 0.01 },
  fetchUserInfo: { path: '/app/v2/fetch_user_info', params: ['user_id'], price: 0.01 },
  fetchUserPostList: { path: '/app/v2/fetch_user_post_list', params: ['user_id'], price: 0.01 },
  fetchVideoCommentList: { path: '/app/v2/fetch_video_comment_list', params: ['item_id'], price: 0.01 },
  searchVideo: { path: '/app/v2/search_video', params: ['keyword'], price: 0.01 },
};
