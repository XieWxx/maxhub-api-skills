...
function formatItem(rawData) {
  ...
  return {
    id: safeGet(item, ['video_id', 'id', 'item_id', 'note_id', 'bvid', 'video_id', 'uid']),
    ...
    stats: {
      playCount: formatNumber(safeGet(item, ['video_play_count', 'playCount'], 0)),
      likeCount: formatNumber(safeGet(item, ['video_like_count', 'likeCount'], 0)),
      commentCount: formatNumber(safeGet(item, ['video_comment_count', 'commentCount'], 0)),
    },
 ...
 */
const formatXigua_Web = formatItem;
const formatXigua_App = formatItem;
const formatXigua_Search = formatItem;
