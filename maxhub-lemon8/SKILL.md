...
Lemon8数据采集——lemon8、生活方式、图文等平台数据的智能采集与分析工具，支持视频搜索、用户分析、热门趋势追踪等能力，用自然语言即可获取数据。
...
直接输入：lemon8、生活方式、图文、种草、lemon8搜索

### 使用示例

1. 示例：Search Lemon8 for skincare tips → 返回笔记列表，包含标题、作者、点赞数
